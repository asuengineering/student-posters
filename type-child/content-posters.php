...
<div class="author-info" style="padding:20px; border:3px solid maroon; background-color:#c4c4c4;">
    <div class="row">
        ...
        <div class="col-10 col-sm-10">
            <div class="author-description">
                <h3 class="author-title" style="color:green;">
                    <?php echo carbon_get_post_meta( get_the_ID(), 'crb_student1name' ); ?>
                </h3>
                <p class="author-bio" style="color:maroon;">
